import { WorkplaceGridQuery } from '@/pages/DoctorVerifyWorkplace/api';
import DetailComponent from '@/pages/DoctorVerifyWorkplace/components/Detail';
...
const DoctorVerifyWorkplace = () => {
  ...
  const columns: ProColumns<DoctorVerifyWorkplace.DoctorItem>[] = [
    {
      title: '审批单号',
      dataIndex: 'verifyId',
      align: 'center',
  ...
  return (
    <PageContainer header={{ breadcrumb: {} }}>
      <ProTable<DoctorVerifyWorkplace.DoctorItem>
        actionRef={ref}
        rowKey="verifyId"
        search={false}
        ...
        columns={columns}
        columnsState={{
          persistenceKey: 'Setting-ProTable-ColumnsState-DoctorVerifyWorkplace',
        ...
        request={async (params, sort = {}, filter) => {
          console.log(sort, '99999999999999999999999999');
          const res = await WorkplaceGridQuery({
...
export default DoctorVerifyWorkplace;
