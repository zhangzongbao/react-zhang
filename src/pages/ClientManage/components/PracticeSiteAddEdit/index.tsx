import { addDoctorWorkplace, getDeptList, getDoctorWorkplace, searchHospitalName, updateDoctorWorkplace } from '@/pages/ClientManage/api';
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: 384, paddingLeft: 14 }}>
              ...
              <div style={{ display: 'flex', margin: '12px 0' }}>
                ...
                <div className="color-text-88 font-14">{practiceSiteItem?.districtType}</div>
              </div>
              <div style={{ display: 'flex', margin: '12px 0' }}>
